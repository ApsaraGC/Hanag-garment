...
<body>
    ...
    <div class="container">
        ...
        <!-- Add Brand Form -->
        <form action="{{ route('admin.updateBrand', ['id' => $brand->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" id="brand_name"value="{{old('brand_name',$brand->brand_name)}}" name="brand_name"  placeholder="Enter brand name">
            </div>
